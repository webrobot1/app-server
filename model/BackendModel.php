...
{	
	function status(){
		return [
			'workerman'=>\Edisom\Core\Cli::cmd(\Edisom\Core\Cli::get('\\Edisom\\App\\server\\model\\ServerModel', 'status')),
	...
	function stop(){
		\Edisom\Core\Cli::cmd(\Edisom\Core\Cli::get('\\Edisom\\App\\server\\model\\ServerModel', 'stop'));	
	}		
